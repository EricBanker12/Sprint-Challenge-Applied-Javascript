...
1. What is the DOM?
   ...
   Document Object Model is the object representation of the tree of elements and nodes that is created from the HTML and can be manipulated by Javascript.

2. What is an event?

   An Event is an interaction between the user and webpage/browser that is tracked by the browser.

3. What is an event listener?

   An Event Listener is a function triggered by an event and given data about the event.

4. Why would we convert a NodeList into an Array?

   We would convert NodeList to an Array to access Array methods such as `array.map(cb)`.

5. What is a component?

   A Component is reusable code that can be used to create multiple elements or nodes with similar structure, style, and/or function.
